...
const getCellClass = (value) => {
  ...
  if (typeof value === "number") return "text-right font-mono";
  return "";
};
        ...
        <div class="flex flex-col sm:flex-row sm:items-center gap-2 w-full">
          ...
          <div class="flex flex-wrap items-center gap-2 mt-2 sm:mt-0">
            <button
              ...
              :class="[
                'px-3 py-1.5 text-sm font-medium text-white rounded-md shadow-sm hover:opacity-90 transition-all duration-150 focus:ring-2 focus:ring-offset-2 focus:outline-none',
                action.color ? `bg-${action.color}-500 hover:bg-${action.color}-600 focus:ring-${action.color}-500` : 'bg-blue-500 hover:bg-blue-600 focus:ring-blue-500',
                action.class || '',
              ]"
            >
            ...
            <button
              ...
              class="px-3 py-1.5 text-sm font-medium text-white bg-green-600 hover:bg-green-700 rounded-md shadow-sm hover:shadow-md transition-all duration-150 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:outline-none"
              @click="downloadCSV"
            >
              <span class="flex items-center gap-1.5">
